...
import {isCanvasSupported,intToHexColorString,getLineDashArray,getBezierPoints} from '../helpers/utils';
import RenderHelper from '../helpers/render';
import AnimationHelper from '../helpers/animator';

export var SplineAreaChart =  function (plotUnit) {
	...
	for (var j = 0; j < plotUnit.dataSeriesIndexes.length; j++) {
		...
		if (dataPoints.length > 0) {
			...
			var color = "#4572A7 ";//dataSeries._colorSet[i % dataSeries._colorSet.length];
			ctx.fillStyle = color;
